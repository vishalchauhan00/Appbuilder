...
import timelineChart from '../../../assets/uimockup/charts/timeline.png';
import IconButton from '@material-ui/core/IconButton';
import FullscreenIcon from '@material-ui/icons/Fullscreen';

export default function UITimelineChart(props) {
  const uiData = props.data;

  uiData['timeline']['rowLabelStyle']['fontName'] = uiData['font']['fontName'];
  uiData['timeline']['barLabelStyle']['fontName'] = uiData['font']['fontName'];
